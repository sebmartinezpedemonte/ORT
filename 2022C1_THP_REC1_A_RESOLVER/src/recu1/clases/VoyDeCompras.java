...
public class VoyDeCompras {
	...
	/*
	Articulos Comprados
	CARNICERIA La Res Puesta - carne picada (1.0)
	VERDULERIA No Lo hagas, Vega! - papas (8.0)
	VERDULERIA No Lo hagas, Vega! - cebolla de verdeo (4.0)
	ALMACEN Ali-Macen - fosforos (1.0)
	...
	*/
	...
	private String buscarNombreNegocio(Rubro rubro) {
		...
		int i = 0;
		while(negocios.size()>i && respuesta == null) {
