...
public class CasaElectrodomesticos {
	...
	public void ofrecerProductos() {
		...
		}//sin usar el metodo getNombreClase() de la clase Electrodomestico, usando el toString() en vez
	}
	
	public void comprarElectrodomestico() {
...
Total: $36168
	...
	public void detalleCompleto(ArrayList<Electrodomestico> electrodomesticosElegidos) {
		int total = 0;
