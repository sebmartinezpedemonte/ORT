...
public static void main(String[] args) {
	...
	/*
	 * En el programa principal mostrá cuántos días transcurrieron antes (no sera desde el comienzo del año?) del
comienzo del año y qué día del año es el día de cumpleaños de cada integrante del
grupo.
	 */
	Anio anio = new Anio();
	...
	System.out.println("Dias transcurridos desde el comienzo del año: " + diasTranscurridosConLocalDate + " (Usando DateTime)");
	...
	int cumpleaniosMatias = anio.diasTranscurridos(10) + 12;
